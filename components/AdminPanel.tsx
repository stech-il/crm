...
import { Plus, Settings, ChevronDown, Pencil, Trash2, Database, RotateCcw, Tag, Zap, Webhook, FileText, Key, Book, Users, ListChecks } from "lucide-react";
        ...
        <div className="flex gap-2">
          {isAdmin && (
            <>
              ...
              <Link href="/admin/workflows" className="flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-50"><ListChecks className="h-4 w-4" /> אוטומציות</Link>
