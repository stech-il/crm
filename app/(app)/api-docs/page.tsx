  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <section id="entities" className="mb-12">
        <h2 className="text-xl font-bold text-slate-800 mb-4">ישויות</h2>

        <div className="mb-8">
          <h3 className="font-semibold text-slate-700 mb-2">GET /api/v1/entities</h3>
          <p className="text-slate-600 mb-2">רשימת כל הישויות (מודולים) במערכת.</p>
        ...
        <div className="rounded-xl border border-slate-200 overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-200">
              ...
              <tr><td className="px-4 py-3">404</td><td className="px-4 py-3">ישות או רשומה לא נמצאו</td></tr>
